...
export function modifyMenuAuthority2(data) {
  return fetch({
    url: '/api/admin/group/authority/menu',
    method: 'post',
    data: data
  });
}

export function modifyUpdateMenuAuthority(id, data) {
  return fetch({
    url: '/api/admin/group/' + id + '/authority/updateMenu',
    method: 'post',
    params: data
  });
}
...
export function getMobileXxtMenuAuthority(id,xxdm) {
  return fetch({
    url: '/api/admin/group/' + id + '/authority/xxtAuthorityMobileMenu?xxdm='+xxdm,
    method: 'get'
  });
}

export function saveMobileXxtMenuAuthority(id,data) {
  return fetch({
    url: '/api/admin/group/' + id + '/authority/xxtAuthorityMobileMenu',
    method: 'post',
    data:data
  });
}
