...
export function saveSignImage(obj) {
  return fetch({
    url: '/api/base/jcJzgjbsj/saveSignImage',
    method: 'post',
    params: obj
  })
}
export function getSignImage(obj) {
  return fetch({
    url: '/api/base/jcJzgjbsj/getSignImage',
    method: 'post',
    data: obj
  });
}

export function getTeacherInfoByZgh(query) {
  return fetch({
    url: '/api/base/jcJzgjbsj/getJzgInfo',
    method: 'get',
    params: query
  });
}
