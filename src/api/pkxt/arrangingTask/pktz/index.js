...
export function timeTableInfo(taskId) {
  return fetch({
    url: '/api/course/pktz/tasks/' + taskId + '/timeTableInfo',
    method: 'get',
    params: null
  });
}
...
export function coursePlanList(taskId) {
  return fetch({
    url: '/api/course/pktz/tasks/' + taskId + '/coursePlanList',
    method: 'get'
  });
}
...
export function getJskbByZgh(query) {
  return fetch({
    url: '/api/course/pkjg/getJskbByZgh',
    method: 'post',
    data: query
  });
}
...
export function getJskbUrl(query) {
  return fetch({
    url: '/api/course/pkjg/getJskbUrl',
    method: 'get',
    params: query
  });
}
...
export function ruleList(taskId) {
  return fetch({
    url: '/api/course/pktz/tasks/' + taskId + '/coursePlanRule',
    method: 'get'
  });
}
...
export function pkJxjhList(taskId) {
  return fetch({
    url: '/api/course/pktz/tasks/' + taskId + '/pkJxjhList',
    method: 'get'
  });
}
...
export function getAlljs(dataModel) {
  return fetch({
    url: '/api/course/pkjg/getAlljs',
    method: 'post',
    params: dataModel
  });
}
export function exportZjsrkb(query) {
  return fetch({
    url: '/api/course/pkjg/exportZjsrkb?rwid=' + query,
    method: 'get',
