...
/**任务批量导出表格下载 2019-05-22 */
export function rwBatchexportExcel(query) {
  return fetch({
    url: '/api/netcore/smartcredit/v2/Xmcj/RwBatchExportExcel',
    method: 'get',
    responseType: 'arraybuffer',
    params: query
  });
...
/**项目批量导出表格下载 2019-05-22 */
export function xmBatchexportExcel(query) {
  return fetch({
    url: '/api/netcore/smartcredit/v2/Xmcj/XmBatchExportExcel',
    method: 'get',
    responseType: 'arraybuffer',
    params: query
  });
...
//查询班级
export function getGrantedClass(query) {
  return fetch({
    url: '/api/base/jcBjsj/getGrantedClass',
    method: 'get',
    params: query
  })
}
