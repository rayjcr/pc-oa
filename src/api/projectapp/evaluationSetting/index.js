 ...
 */
  ...
  /** 获取悬赏任务分页 */
  export function getEvaluationItemCategory(query){
      return fetch({
          url: `${quality}/evaluationItemCategory/custom/page`,
          method: 'get',
          params: query
      });
  }
  ...
  /** 新增悬赏任务 */
  export function addEvaluationItemCategory(query){
      return fetch({
          url: `${quality}/evaluationItemCategory/custom`,
          method: 'post',
          data: query
      });
  }
  ...
  /** 修改悬赏任务 */
  export function editEvaluationItemCategory(query){
      return fetch({
          url: `${quality}/evaluationItemCategory/custom`,
          method: 'put',
          data: query
  ...
  /** 删除悬赏任务 */
  export function delEvaluationItemCategory(id){
      return fetch({
          url: `${quality}/evaluationItemCategory/custom/${id}`,
          method: 'delete',
      });
  }

  /** 获取子任务列表 */
  export function getEvaluationItemSubCategory(query){
      return fetch({
          url: `${quality}/evaluationItemSubCategory/list`,
          method: 'get',
          params: query
      });
  }
  ...
  /** 获取子任务详细 */
  export function getEvaluationItemSubCategoryDetail(id){
      return fetch({
          url: `${quality}/evaluationItemSubCategory/show/${id}`,
          method: 'get',
      });
  }

  /** 创建子任务 */
  export function addEvaluationItemSubCategory(query){
      return fetch({
          url: `${quality}/evaluationItemSubCategory/save`,
          method: 'post',
          data: query
      });
  }
  ...
  /** 编辑子任务 */
  export function changeEvaluationItemSubCategory(query){
      return fetch({
          url: `${quality}/evaluationItemSubCategory/update`,
          method: 'put',
          data: query
      });
  }
  ...
  /** 删除子任务 */
  export function deleteEvaluationItemSubCategoryDetail(id){
      return fetch({
          url: `${quality}/evaluationItemSubCategory/delete/${id}`,
          method: 'delete',
      });
  }

  // 分页获取评价记录集合
  export function getEvaluationRecordList(query){
    return fetch({
        url: `${quality}/evaluationRecord/custom/page`,
        method: 'get',
        params: query
    });
  }
  ...
  // 分页获取评价记录集合
  export function getClassDetailByTask(query){
    return fetch({
        url: `${quality}/evaluationRecord/getList`,
        method: 'post',
        data: query
    });
  }
  ...
  export function auditSubmit(query){
    return fetch({
        url: `${quality}/evaluationRecord/auditRewardItem`,
        method: 'get',
        params: query
    });
  }
