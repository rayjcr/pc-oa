...
/**个人评价统计 */
export function userStatistics(query,_this){
...
/**班级任务提交情况列表 */
export function evaluationRecodeList(query){
    return fetch({
        url: `${preQuality}/evaluationRecodeItem/pageList`,
        method: 'post',
        data: query
    });
}
...
/**获取班级荣誉统计集合 */
export function getClassHonor(query){
    return fetch({
        url: `${preQuality}/classHonorRecord/static/getListVO`,
        method: 'get',
        params: query
    });
}
...
/** 获取学生各维度下分数及一级勋章数量 */
export function dimensionMedalScore(query){
    return fetch({
        url: `${preQuality}/userStatistics/static/dimensionMedalScore`,
        method: 'get',
        params: query
    });
}
 ...
 * time:2020-07-29
 */
export function rewardCassStatistics(query){               //按班级统计
    return fetch({
        url: `${preQuality}/rewardTask/classStatistics`,
        method: 'get',
        params: query
    });
}
export function rewardClassStatisticsDetail(query){               //按班级统计明细
    return fetch({
        url: `${preQuality}/rewardTask/classStatisticsDetail`,
        method: 'get',
        params: query
    });
}
export function primaryStatistics(query){               //主任务统计
    return fetch({
        url: `${preQuality}/rewardTask/primaryStatistics`,
        method: 'get',
        params: query
    });
}
export function taskStatistics(query){               //按任务统计
    return fetch({
        url: `${preQuality}/rewardTask/taskStatistics`,
        method: 'get',
        params: query
    });
}
export function taskStatisticsDetail(query){               //按任务统计明细
    return fetch({
        url: `${preQuality}/rewardTask/taskStatisticsDetail`,
        method: 'get',
        params: query
    });
}
...
// 导出3个接口
// 班级荣誉导出
export function exportClassHonorExl(query){               //按任务统计明细
    return fetch({
        url: `${preQuality}/classStatistics/static/exportClassHonorExl`,
        method: 'POST',
        data: query,
        responseType: 'arraybuffer',
    });
...
// 学生荣誉导出
export function exportRecordExl(query){               //按任务统计明细
    return fetch({
        url: `${preQuality}/classStatistics/static/exportRecordExl`,
        method: 'POST',
        data: query,
        responseType: 'arraybuffer',
    });
...
// 班级统计导出
export function exportClassStatics(query){               //按任务统计明细
    return fetch({
        url: `${preQuality}/classStatistics/static/exportClassStatics`,
        method: 'POST',
        data: query,
        responseType: 'arraybuffer',
    });
