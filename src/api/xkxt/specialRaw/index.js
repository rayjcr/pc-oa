...
export function getPageList(query) {
  return fetch({
    url: '/api/course/special/queryPageList',//查询成绩单管理列表
    method: 'post',
    data: query
  });
}
...
export function saveSpecialInfo(query) {
  return fetch({
    url: '/api/course/special/saveSpecialInfo',//查询成绩单管理列表
    method: 'post',
    data: query
  });
}
...
export function getTcsLx(query) {
  return fetch({
    url: '/api/course/special/getTypeInfo',
    method: 'get',
    params: query
  });
}
...
export function getTcsLxList(query) {
  return fetch({
    url: '/api/course/xkxtXslxb/ajaxGetTypeList',
    method: 'get',
    params: query
  });
}
...
export function getTreeNode(query) {
  return fetch({
    url: '/api/course/special/getTreeNode',
