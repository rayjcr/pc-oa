...
export function page(query) {
  return fetch({
    url: '/api/course/xkxtXsyfp/pagelist',
    method: 'post',
    data: query
  });
}
...
export function xsyfpxq(query) {
	  return fetch({
	    url: '/api/course/xkxtXsyfp/pfxsxq',
	    method: 'get',
	    params: query
	  });
}
...
export function getIstsdkc(query) {
  return fetch({
    url: '/api/course/xkxtXsyfp/isTsdkc',
    method: 'get',
    params: query
  });
}
...
export function getTcsXs(query) {
  return fetch({
    url: '/api/course/special/'+query.lxid+'/students',
    method: 'get',
    params: query
  });
}
...
export function saveXsxkInfo(query) {
  return fetch({
    url: '/api/course/xkxtXsyfp/saveXsxkInfo',
    method: 'post',
    data: query
  });
}
...
/**下载模板**/
export function exportXsyfpMb() {
  return fetch({
    url: '/api/course/xkxtXsyfp/static/exportXsyfpmd',
    method: 'get',
...
export function againUp(query) {
  return fetch({
    url: '/api/course/xkxtXsyfp/againUplode',
    method: 'post',
    data: query
  });
}
...
export function getBjSduntByBjid(query) {
  return fetch({
    url: '/api/course/xkxtXsyfp/getBjSduntByBjid',
    method: 'get',
    params: query
  });
}
