...
export function getSaveXklsxx(params) {
  return fetch({
    url: '/api/course/xklsxx/saveUpdateXklsxx',
    method: 'post',
    data: params
  });
}
...
export function getXkjsAll(id, query) {
  return fetch({
    url: '/api/course/xklsxx/getXklsxxByKsid/' + id,
    method: 'get',
    data: query
  });
}
...
export function getSaveJklsxx(params) {
  return fetch({
    url: '/api/course/jklsxx/saveUpdateJklsxx',
    method: 'post',
    data: params
  });
}
...
export function getselectJklsList(data) {
  return fetch({
    url: '/api/course/jklsxx/getJklsList',
    method: 'get',
    params: data
  });
}
...
export function getJklsBynjksid(data) {
  return fetch({
    url: '/api/course/jklsxx/getJklsBynjksid',
    method: 'get',
    params: data
  });
}
...
export function getJktjBynjksid(data) {
  return fetch({
    url: '/api/course/kcjktj/getJktjBynjksid',
    method: 'get',
    params: data
  });
}
...
export function plxgJktj(params) {
  return fetch({
    url: '/api/course/kcjktj/plxgJktj',
    method: 'post',
    data: params
  });
}
