...
export function getAllKc(params) {
  return fetch({
    url: '/api/course/kskcxx/getKsCdxx',
    method: 'post',
    data: params
  });
}
...
export function bcKcSettings(params) {
  return fetch({
    url: '/api/course/kskcxx/whKcszData',
    method: 'post',
    data: params
  });
}
...
export function getKsStuNum(data) {
  return fetch({
    url: '/api/course/kskcxx/getStuNumber',
    method: 'post',
    params: data
  });
}
...
export function delKcsz(data) {
  return fetch({
    url: '/api/course/kskcxx/deleteKcsz',
    method: 'post',
    params: data
  });
}
...
export function checkDataByKsid(data) {
  return fetch({
    url: '/api/course/kskcxx/checkData',
    method: 'get',
    params: data
  });
}
...
export function clearDataByKsid(data) {
  return fetch({
    url: '/api/course/kskcxx/clearData',
    method: 'get',
    params: data
  });
}
...
export function updateExamRoomName(params) {
  return fetch({
    url: '/api/course/kskcxx/updateKcInfo',
    method: 'post',
    data: params
  });
}
