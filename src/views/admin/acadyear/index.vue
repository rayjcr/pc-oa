    ...
    <div class="app-container calendar-list-container">
      <div class="u_TableMain">
          ...
          <div class="filter-container">
              ...
              <el-button v-if="unitCode == 5? false: true" class="filter-item"   @click="handleCreate" type="primary" icon="edit">添加</el-button>
          </div>

          <div class="m_GenTableBox">
          <el-table class="tableBorder" ref="singleTable" :key='tableKey' :data="list" v-loading.body="listLoading" fit highlight-current-row style="width: 100%" :row-class-name="tableRowClassName">
              ...
              <el-table-column align="center" label="当前学年学期" width="150">
                  <template slot-scope="scope">
        ...
        <el-dialog :title="textMap[dialogStatus]" :close-on-click-modal='false' :visible.sync="dialogFormVisible" width="450px" :before-close="cancel">
