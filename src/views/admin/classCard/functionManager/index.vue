    ...
    <div class="app-container">
        <div class="u_TableMain">
            <div class="filter-container innerTab">
                <el-button icon="el-icon-plus" type="primary">新增功能模块</el-button>
            </div>
            <div class="m_GenTableBox">
                <div class="minTableBox">
                    <el-table :data="dataList">
                        <el-table-column label="功能名称" width="150" prop="xxdm"></el-table-column>
                        <el-table-column label="说明" width="150" prop="xxmc"></el-table-column>
                        <el-table-column label="使用范围" width="150"  align="center"></el-table-column>
                    </el-table>
