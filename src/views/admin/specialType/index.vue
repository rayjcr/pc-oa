<template>
  <div class="app-container calendar-list-container">
    ...
    <div class="u_TableMain">
        ...
        <el-table class="tableBorder"  :key='tableKey' :data="list" v-loading.body="listLoading" fit highlight-current-row style="width: 100%">
    ...
    <el-dialog :title="textMap[dialogStatus]"  :visible.sync="dialogFormVisible" width="400px" top="30vh">
