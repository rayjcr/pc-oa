<template>
  ...
  <div class="u_TableMain">
    <el-row class="studentManaerwrapper">
      ...
      <div class="studentManaerright">
        <div class="calendar-list-container teacherManaerWrapper">
          <div class="studentpagestyletopdiv">
          ...
          <el-table @selection-change="handleSelectionChange"
            ...
            <el-table-column align="center" label="职工号" width="100">
              ...
              <el-tabs :tab-position="tabPosition" style="min-height: 400px;">
                <el-tab-pane label="基本信息">
                  ...
                  <el-form-item label="职工姓名"
                    ...
                    <el-input v-model="form.xm" :maxlength="6"  placeholder="请输入职工姓名"></el-input>
                  </el-form-item>
                ...
                <el-tab-pane label="详细信息">
                  ...
                  <el-form-item label="手机号码" size="small" prop="opationSjhm">
                    <!-- <el-input :maxlength="15" v-model="form.opation_sjhm" placeholder=""></el-input> -->
                    <el-input v-model="form.opationSjhm"></el-input>
                  </el-form-item>
                </el-tab-pane>
                ...
                <el-tab-pane label="用户信息">
                  ...
                  <el-upload
                    ...
                    action="/api/base/jcJzgjbsj/sctps"
                     accept=".jpg,.png"
                    :headers="headers"
    ...
    data() {
      ...
      return {
        ...
        rules: {
          ...
          opationSjhm: [{ validator: validateNum, trigger: 'blur' }]
        },
    ...
    methods: {
      ...
      handleUpdate(row) {
        ...
        getObj(row.uuid).then(response => {
          ...
          this.form_mm = '******';
          this.$set(this.form,'opationSjhm',this.form.sjhm);
      ...
      create(formName) {
        this.$refs[formName].validate(valid => {
          if (valid) {
            ...
            this.form.sjhm = this.form.opationSjhm
      ...
      handleImageSuccess(res, file) {
        this.form.imagePath  = res.data[0].path;
        this.schimagepath = URL.createObjectURL(file.raw);
      },
      // 上传前对文件的大小的判断
