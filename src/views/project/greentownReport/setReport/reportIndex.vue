...
/**封面 */
import coverpage from '../reportTemplate/cover';
/**学生风采 */
import stuphoto from '../reportTemplate/stuphoto';
/**身体素质 */
import physical from '../reportTemplate/physical';
/**成绩汇总 */
import summaryscScore from '../reportTemplate/summary';
/**课程自主善学 */
import course from '../reportTemplate/course';
/**品德行为 */
import morals from '../reportTemplate/morals';
/**实践创新 */
import practice from '../reportTemplate/practice';
/**国际理解 */
import international from '../reportTemplate/international';
/**成长规划 */
import growup from '../reportTemplate/growup';
/**校长寄语 */
import message from '../reportTemplate/message';
/**封底 */
import backcover from '../reportTemplate/backcover';
