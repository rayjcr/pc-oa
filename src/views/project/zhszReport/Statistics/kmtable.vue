<template>
    <el-table border :data="TableData"  :style="{width:width}" class='tPopBoxTable xmpbtb' :span-method="arraySpanMethod" >
...
<style lang="scss">
    ...
    .xmpbtb .el-table__header-wrapper tr{ height: 60px;}
    .xmpbtb .el-table__header-wrapper th{ padding: 0;}
    .tPopBoxTable{
