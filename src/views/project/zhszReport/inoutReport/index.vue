<template>
    <div class="app-container calendar-list-container" style="padding-bottom:50px;">
        <div class="u_TableMain">
            <div class="filter-container">
                <el-form ref="form" :model="formlist">
                    <el-row>
                        <el-form-item label="学年学期" style="min-width:600px;">
                            <el-select  class="schoolYear" v-model="listQuery.xn" placeholder="请选择" size="small" @change="getList" clearable>
                                <el-option
                            ...
                            <el-select  class="schoolYear" v-model="listQuery.xq" placeholder="请选择" size="small"  @change="getList" clearable>
                                <el-option
            ...
            <div class="m_GenTableBox">
                <!-- 卡片区beg -->
                <div class="table-container" style="max-width:1000px; min-width:900px;">
                    ...
                    <el-card class="box-card" v-for="(item, index) in list" :key="index" style="width: 100%;">
                        <div class="content_left">
                            <div class="title">
                                <span class="title_info">{{item.mc}}</span>
                                <!-- {{item.xn}}{{item.xq === '01'? '上学期':'下学期'}}  -->
