  ...
  <div class="app-container calendar-list-container">
    ...
    <div class="u_TableMain">
        ...
        <div class="filter-container">
            ...
            <el-button class="filter-item" style="margin-left: 5px;" @click="handleCreate" type="primary" icon="edit">添加</el-button>
        </div>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" width="600px">
      <el-form :model="form" ref="form" :rules="rules" label-width="110px">
        <el-row :gutter="18">
            ...
            <el-form-item label="关联校区" prop="glxq">
              <el-input :maxlength="20" v-model="form.cdmc" placeholder=""></el-input>
            </el-form-item>

            <el-form-item label="关联班级" prop="glbj">
              <el-input :maxlength="20" v-model="form.cdmc" placeholder=""></el-input>
            </el-form-item>
