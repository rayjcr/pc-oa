<template>
    <div class="app-container calendar-list-container">
        ...
        <!--新增采集规则价项-->
        <el-dialog :title="textMap[dialogStatus]+'采集规则'" @closed="closeRuleLayer" :close-on-click-modal="false" :visible.sync="dialogFormVisible" width="900px">
                    ...
                    <div class="pjxMain flexbox">
                        ...
                        <div class="checkPjx cusMiniScroll">
                            <transition-group name="bounce">
                                <div class="pjxItem" :label="item.id" :key="item.id" v-for="(item,index) in checkEvaluate" @click="removeCheckEvaluateFun(item,index)">
                                    <div class="pjxImg">
                ...
                <div class="collectRight">
                    ...
                    <div class="pjxBox">
                        ...
                        <div class="pjxList cusMiniScroll">
                            <transition-group name="bounce">
                                <div class="pjxItem" v-show="!item.ischeck" @click="checkEvaluateFun(item)" :label="item.id" :key="item.id" v-for="(item,index) in EvaluateList">
                                    <div class="pjxImg">
                                        <el-image fit="cover"  :src="item.icon"    >
                                            <div slot="error"  >
        ...
        filterEvaluateLisst(){
            ...
            if(this.rewardType){
                if(this.rewardType!="0"){
									this.EvaluateList = _.filter(this.EvaluateList,(eva)=>{return eva.rewardTypeStr.indexOf(this.rewardType)>=0})
                }
            }
