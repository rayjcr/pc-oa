            ...
            <el-tab-pane>
                ...
                <div class="m_GenTableBox" v-loading="isLoading">
                    ...
                    <div class="goodsBox" v-for="(item,index) in goodsList">
                        ...
                        <div slot="reference" class="delGoods el-icon-delete" @click.native="confirmDel(item)"></div>
                        </el-popover>
...
export default {
    ...
    methods: {
        ...
        async getGoodsTypeList(){
            var res = await qualityApi.getGoodsTypeList({schoolCode:localStorage.getItem("xxdm")});
            if(res.resultCode != 1){
