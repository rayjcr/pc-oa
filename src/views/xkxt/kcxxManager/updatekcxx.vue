      ...
      <el-form :model="form"  ref="form" label-width="150px">
        ...
        <el-form-item label="授课日期"    >
          <el-alert
            ...
            <el-date-picker v-model="skksrq" :picker-options="pickerStartOptions" @change = "resetDate" type="date" placeholder="选择日期"  ></el-date-picker>
            <span class='padding_transverse_10'>至</span>
            <el-date-picker v-model="skjsrq" :picker-options="pickerEndOptions" type="date" placeholder="选择日期"   ></el-date-picker>
...
import { getAll,saveaddkcxx ,ck ,savexg,checkCdxx} from 'api/xkxt/kcxxManager/index'
  ...
  name: 'App',
   ...
   data() {
    return {
      ...
      pickerEndOptions: {
        disabledDate: time => time.getTime() < this.skksrq
      },
      avliableWeek:[]
    }
  },
 ...
 methods:{
   ...
   checkCdxx(index){
     ...
     if(cdid!=''){
       param.kcdm = this.kcdm;
       param.xxdm = this.xxdm;
       param.skksrq = this.skksrq;
       param.skjsrq = this.skjsrq;
