<template>
    <div class="calendar-list-container">
        ...
        <el-col :span="24" class="toolbar" style="margin-top: 10px;">
          <el-form :inline="true">
            <el-form-item>
              <el-button type="info" plain @click="handleExportXkmd" v-loading="exportLoading">导出课程选课名单</el-button>
        ...
        <el-table :key='tableKey' :data="list" v-loading.body="listLoading" border fit highlight-current-row style="width: 100%">
          ...
          <el-table-column prop="xmys"  align="center" label="选满用时" width="100"></el-table-column>
<!--          <el-table-column prop="sfsf"  align="center" label="是否收费" width="80">
            <template slot-scope="scope">
              <span>{{(scope.row.sfsf == 0) ? "否":"是"}}</span>
            </template>
          </el-table-column>-->
...
<script>
import { kcxxPage, ckxkjg, copyXkxx, getXkmdUrl, exportKcxkmd} from 'api/xkxt/xkjgmanager/index';
...
export default {
  ...
  methods: {
    ...
    async handleExportXkmd() {
      ...
      param.zsGroup = data.temp[0]+'';
      param.kcXnGroup = data.temp[1]+'';
      param.kcXqGroup = data.temp[2]+'';
      param.kclbGroup = data.temp[3]+'';
      var res = await exportKcxkmd(param);
      ...
      downloadElement.download = '课程选课名单.xls'; // 下载后文件名
